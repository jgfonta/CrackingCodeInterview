...
// other reachable vertex in graph.
{
  ...
  ArrayDeque<Flight> pq = new ArrayDeque<Flight>(20);   // Assume at most 20 vertices
  String vertex;
  ArrayDeque<String> vertexQueue = new ArrayDeque<String>();
...

{
  ...
  public static void main(String[] args) 
  {
    ...
    System.out.println("Creating graph in figure 10.3 with linked list graph");
    WeightedGraphInterface<String> graph = new LLGraph<String>();
