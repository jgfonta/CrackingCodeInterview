...
//Complete the implementation of the Weighted Graph (WeightedGraph.java) that we began in this 
//chapter by providing bodies for the methods:
// isEmpty - done
// isFull - done
// hasVertex - done
// clearMarks - done
...
// isMarked - done
// getUnmarked - done
// in the WeightedGraph.java file. 
//Test the completed implementation using the UseGraph class. 
//When implementing hasVertex, do not forget to use the equals method to compare vertices.
...
public class DirectedGraph<T> implements WeightedGraphInterface<T>
{
  ...
  public ArrayDeque<T> getToVertices(T vertex)
  // Returns a queue of the vertices that vertex is adjacent to.
  {
    ArrayDeque<T> adjVertices = new ArrayDeque<T>();
    int fromIndex;
    int toIndex;
